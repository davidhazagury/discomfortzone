...
hiking = Event.new(title: "special-hike", description: "Early birds catches the worm and the best light in the world !! We are gonna enjoy the most beautiful landscape that vienna has to offer. Please be advised to bring proper equipment since the trip will be the whole weekend - that includes a Hiking backpack
Weather-appropriate clothing (think moisture-wicking and layers), Hiking boots or shoes, Plenty of food, Plenty of water, sleeping bag, some toold like a knife.. As the host I will bring a First-aid kit as I'm a trained medic. THIS IS A REAL OUTDOOR ADVENTURE, whoooo !!", address: "vienna", capacity: 5, user_id: user3.id, start_time: "2020-08-10 12:00", end_time: "2020-08-12 18:00")
...
paragliding = Event.new(title: "paragliding", description: "Exhileration experience just floating through the air and through the clouds", address: "switzerland", capacity: 4, user_id: user5.id, start_time: "2020-07-12 12:00", end_time: "2020-07-12 18:00")
